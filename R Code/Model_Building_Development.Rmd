---
title: "Model Building & Development"
...
# Data Portion for submission
```{r}
submission_solvent <- CQD_final_set %>%
  filter(solvency == 1)

subimission_insolvent <- CQD_final_set %>%
  filter(solvency == 0) %>%
  sample_n(10000)

# submission data
submission_data <- rbind(submission_solvent, subimission_insolvent)

write.csv(submission_data, "C:/Users/amaut/OneDrive/Documents\\submission_data.csv", row.names = FALSE)
