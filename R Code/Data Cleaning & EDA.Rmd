...
# Removing NA's
```{r}
combined_quaterly_data_1 %>%
        filter(solvency == 1) %>%
        summary(is.na(combined_quaterly_data_1))
...
```{r}
write.csv(combined_quaterly_data_1, "C:/Users/amaut/OneDrive/Documents\\combined_quaterly_data_1.csv", row.names = FALSE)
